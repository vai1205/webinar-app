                ...
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-lg-4 mr-auto">
                            ...
                            <p className="mt-5">Cardio Web India is the professional body for cardiologists and those working in the area of cardiology including researchers, scientists, cardiovascular.</p>
                            <p className="mb-5">
                            Our Focus is to Attain advanced in scientific knowledge and research in the field of cardiovascular systems in all aspects and to improve basic understanding to find better preventive measures and treatment of all types of Cardio Vascular Disease.
                            </p>
